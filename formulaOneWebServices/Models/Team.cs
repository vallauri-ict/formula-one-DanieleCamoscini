...
namespace formulaOneWebServices.Models
{
    public class Team
    {
        public Team(int id, string teamName, byte[] teamLogo, string @base, string teamChief, string technicalChief, string powerUnit, byte[] carImage, string countryID, int worldChampionships, int polePositions)
        {
            this.id = id;
